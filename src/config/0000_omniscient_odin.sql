...
CREATE TYPE "public"."listing_status" AS ENUM('active', 'sold', 'cancelled', 'delisted');--> statement-breakpoint
CREATE TYPE "public"."order_status" AS ENUM('pending', 'confirmed', 'completed', 'cancelled', 'failed');--> statement-breakpoint
CREATE TYPE "public"."spend_category" AS ENUM('chapter_unlock', 'comic_purchase', 'nft_purchase', 'tip_creator', 'subscription');--> statement-breakpoint
...
ALTER TABLE "creator_transactions" ADD CONSTRAINT "creator_transactions_source_user_transaction_id_user_transactio" FOREIGN KEY ("source_user_transaction_id") REFERENCES "public"."user_transactions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_transactions" ADD CONSTRAINT "user_transactions_reader_id_reader_profile_id_fk" FOREIGN KEY ("reader_id") REFERENCES "public"."reader_profile"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "chapter_comments" ADD CONSTRAINT "chapter_comments_reader_id_reader_profile_id_fk" FOREIGN KEY ("reader_id") REFERENCES "public"."reader_profile"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
