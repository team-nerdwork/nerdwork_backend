...
export const creatorTransactionStatus = pgEnum("creator_transaction_status", [
  "pending",
  "completed",
  "processing",
  "failed",
]);
export const creatorTransactionType = pgEnum("creator_transaction_type", [
  "earning",
  "withdrawal",
  "bonus",
]);
export const earningSource = pgEnum("earning_source", [
  "chapter_purchase",
  "comic_purchase",
  "nft_purchase",
  "tip_received",
...
export const spendCategory = pgEnum("spend_category", [
  "chapter_unlock",
  "comic_purchase",
  "nft_purchase",
  "tip_creator",
...
export const comicSubscribers = pgTable(
  "comic_subscribers",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    readerId: uuid("reader_id").notNull(),
...
export const paidChapters = pgTable(
  "paid_Chapters",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    readerId: uuid("reader_id").notNull(),
...
export const nwtTransactions = pgTable(
  "nwt_transactions",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
...
export const readerProfile = pgTable(
  "reader_profile",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    userId: uuid("user_id").notNull(),
